...
public class Main : SEScene
{
    ...
    public void initialize(SEResourceCache rsc) {
        base.initialize(rsc);
        bg = add_sprite_for_color(Color.instance("#007F79"), get_scene_width(), get_scene_height());
        bg.move(0,0);
        fg = add_sprite_for_color(Color.instance("#7BFFF8"), get_scene_width()*0.15, get_scene_height()*0.20);
        fg.move(100,100);
